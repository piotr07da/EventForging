...
{
    [LoggerMessage(1001, LogLevel.Information, "Cannot write events to the database for stream '{StreamId}' because other events have already been written for the same initiatorId '{InitiatorId}'.")]
    public static partial void WriteIgnoredDueToIdempotencyCheck(this ILogger logger, string streamId, Guid initiatorId);
